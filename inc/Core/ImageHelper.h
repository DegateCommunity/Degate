...
#include <Core/ImageReaderFactory.h>
#include <Core/ImageReaderBase.h>
#include <Core/ImageWriterBase.h>
#include <Core/TIFFWriter.h>
#include <Core/PixelPolicies.h>
#include <Core/StoragePolicies.h>
