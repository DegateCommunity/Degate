...
#include <Core/BinaryLineDetection.h>
#include <Core/Otsu.h>
#include <Core/IPCopy.h>
#include <Core/IPMedianFilter.h>
#include <Core/IPNormalize.h>
#include <Core/IPConvolve.h>
#include <Core/IPThresholding.h>

#include <Core/ImageManipulation.h>
#include <Core/IPImageWriter.h>

#include <Core/RegionList.h>
